...
@section('body')
    <form class='form__registro' onsubmit="register(event)">
        <h1 class='form__registro-titulo'>Cadastrar</h1>
        <label class="label" for='useremail'>Email (também será seu ID):</label> <br>
        <input class='form__registro-input' type="email" name="email" placeholder="seuEmail@gmail.com" required><br><br>
        <label class="label" for="username">Usuario:</label> <br>
        <input class='form__registro-input' type="text" minlength="5" name="name" required placeholder="Seu usuario"><br><br>
