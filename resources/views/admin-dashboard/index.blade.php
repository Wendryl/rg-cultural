            ...
            <tr>
              ...
              <td>
                <div class="d-flex">
                  ...
                  <button class="ms-1 btn btn-sm btn-danger" data-toggle="modal" data-target="#deleteEmployeeModal" {{ $user->type == 1 ? 'disabled': '' }}>
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" class="w-5 h-5">
    ...
    <div class="modal-content">
      <form method="POST" action="/new-user" enctype="multipart/form-data">
        ...
        <div class="modal-body">
          <div class="mb-2 row">
            <div class="col-5 edit-picture" onclick="openFileInput('#newUserModal')">
              <input type="file" name="profile_picture" onchange="setProfilePic(event, '#pic-preview')" accept=".jpg, .jpeg, .png">
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <form method="POST" action="/update" enctype="multipart/form-data">
        ...
        <div class="modal-body">
          <div class="mb-2 row">
            <div class="col-5 edit-picture" onclick="openFileInput('#editUserModal')">
